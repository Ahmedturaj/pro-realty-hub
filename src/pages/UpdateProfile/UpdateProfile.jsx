            ...
            <div className="w-full">
                ...
                <div className="card shrink-0 w-full p-4 bg-base-100">
                    <div className="flex items-center justify-center gap-4">
                        <img className="rounded-full animate__animated animate__fadeIn animate__zoomIn animate__slow	2s w-[150px] h-[150px] md:w-[200px] md:h-[200px] object-cover" src={user && user.photoURL} alt="" />
